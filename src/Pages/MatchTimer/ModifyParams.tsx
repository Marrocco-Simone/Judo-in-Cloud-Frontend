...
export function ModifyParams(props: {
    ...
    const [wazaari_osk_time, setWazaariOskTime] = useState(params.wazaari_osk_time);
    ...
    return (
        <form id="params-form" onSubmit={(e) => {
            e.preventDefault();
            ...
            <button className="orange" type="submit" form="params-form">Salva</button>
        </form>
    )
}
